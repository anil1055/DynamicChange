...
{
    partial class frmNodeEditorView
    {
        /// <summary>
        ...
        {
            this.controlNodeEditor = new TRP_APPHELPER_IDE.ucNodeUser(cAppHelper, frmMainView);
            this.SuspendLayout();
            // 
            // controlNodeEditor
            // 
            ...
            this.Name = "NodeEditorEkran";
            this.Text = "NodeEditor WinForms - Math Sample";
            this.WindowState = System.Windows.Forms.FormWindowState.Maximized;
            this.Load += new System.EventHandler(this.NodeEditor_Load);
        ...
        private TRP_APPHELPER_IDE.ucNodeUser controlNodeEditor;
    }
}